...
#define PAYLOAD_INCREASE_PIN 7     // Payload increase pin - touch to ground by default.
#define WAKEUP_PIN_FALLING 10       // Method 2 pin to ground (power switch solder to switched side of 150R resistor)
#define WAKEUP_PIN_RISING 11        // Method 3 pin to M92T36 pin 5 capacitor / rail
#define JOYCON_STRAP_PIN 9         // Solder to pin 10 on joycon rail
#define VOLUP_STRAP_PIN 12          // Use with Method 3 only. With method 2, the trinket doesn`t boot fast enough. Bootloader needs modification
#define CLOCKPINDOTSTAR   40
