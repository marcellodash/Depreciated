...
void sendPayload(const byte *payload, uint32_t payloadLength)
{
  ...
  if (UNWRITTEN_MODE_NUMBER == 1) {usbBufferedWrite(MODESECTION1, MODESECTION_SIZE);} else
  if (UNWRITTEN_MODE_NUMBER == 2) {usbBufferedWrite(MODESECTION2, MODESECTION_SIZE);} else
  if (UNWRITTEN_MODE_NUMBER == 3) {usbBufferedWrite(MODESECTION3, MODESECTION_SIZE);} else
  if (UNWRITTEN_MODE_NUMBER == 4) {usbBufferedWrite(MODESECTION4, MODESECTION_SIZE);}
  usbBufferedWrite(INBETWEEN, INBETWEEN_SIZE);
  if (UNWRITTEN_PAYLOAD_NUMBER == 1) {usbBufferedWrite (PAYLOADSECTION1, PAYLOADSECTION_SIZE);} else
  if (UNWRITTEN_PAYLOAD_NUMBER == 2) {usbBufferedWrite (PAYLOADSECTION2, PAYLOADSECTION_SIZE);} else
  if (UNWRITTEN_PAYLOAD_NUMBER == 3) {usbBufferedWrite (PAYLOADSECTION3, PAYLOADSECTION_SIZE);} else
  if (UNWRITTEN_PAYLOAD_NUMBER == 4) {usbBufferedWrite (PAYLOADSECTION4, PAYLOADSECTION_SIZE);} else
  if (UNWRITTEN_PAYLOAD_NUMBER == 5) {usbBufferedWrite (PAYLOADSECTION5, PAYLOADSECTION_SIZE);} else
  if (UNWRITTEN_PAYLOAD_NUMBER == 6) {usbBufferedWrite (PAYLOADSECTION6, PAYLOADSECTION_SIZE);} else
  if (UNWRITTEN_PAYLOAD_NUMBER == 7) {usbBufferedWrite (PAYLOADSECTION7, PAYLOADSECTION_SIZE);} else
  if (UNWRITTEN_PAYLOAD_NUMBER == 8) {usbBufferedWrite (PAYLOADSECTION8, PAYLOADSECTION_SIZE);}
