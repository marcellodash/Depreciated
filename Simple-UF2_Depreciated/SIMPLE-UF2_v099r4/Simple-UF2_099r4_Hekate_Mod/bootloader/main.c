...
void launch_firmware()
{
	...
	if (sd_mount())
	{
		if (ini_parse(&ini_sections, "bootloader/hekate_ipl.ini", false))
		{
			...
			ments[2].caption = "Payloads in payloads folder";
			ments[2].handler = launch_tools_payload;
			ments[3].type = MENT_HANDLER;
			ments[3].caption = "Payloads in SD Root";
			ments[3].handler = launch_tools_payload_root;
			ments[4].type = MENT_HANDLER;
			ments[4].caption = "More configs...";
			ments[4].handler = ini_list_launcher;
...
{	//large blank areas are for additional external information
	static const char credits[] =
		...
		"Simple-UF2 brought to you by Mattytrog\n"
...
ment_t ment_top[] = {
	...
	MDEF_CHGLINE(),
	MDEF_MENU("Tools / Info", &menu_tools),
	MDEF_CHGLINE(),
	MDEF_CAPTION("---------------", 0xFF444444),
	MDEF_CHGLINE(),
	...
	MDEF_CAPTION("---------------", 0xFF444444),
	MDEF_CHGLINE(),
	MDEF_HANDLER("About / Other Information", about),
	MDEF_CHGLINE(),
	MDEF_CAPTION("---------------", 0xFF444444),
	MDEF_CHGLINE(),
	MDEF_CHGLINE(),
	MDEF_CHGLINE(),
	MDEF_CAPTION("Modchip Payload Setting:       0", 0xFF00FF00),
	MDEF_CHGLINE(),
	MDEF_CAPTION("Modchip Mode Setting:          0", 0xFF00FF00),
	MDEF_CHGLINE(),
	MDEF_CAPTION("USB Strap detected:          YES", 0xFF00FF00),
	MDEF_CHGLINE(),
	MDEF_CAPTION("VOL+ Strap detected:         YES", 0xFF00FF00),
	MDEF_CHGLINE(),
	MDEF_CAPTION("Joycon Strap Detected:       YES", 0xFF00FF00),
	MDEF_END()
};
menu_t menu_top = {
	ment_top,
	"Simple-UF2 0.9.9r4 - Hekate CTCaer v4.9.1", 0, 0
};
